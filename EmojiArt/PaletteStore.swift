...
//  EmojiArt
//
//  Created by Kürşad Saka on 8.03.2022.
//
...
//            for palatteAsArray in palettesAsPropertyList {
//                if palatteAsArray.count == 3, let id = Int(palatteAsArray[2]), !palettes.contains(where: { $0.id == id}) {
//                    let palette = Palette(name: palatteAsArray[0], emojis: palatteAsArray[1], id: id)
